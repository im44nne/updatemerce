...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p5" src="p5.jpg">
    </div>
    
 <aside>
    <h1 id="as1">Alienware Pro Wireless Gaming Headset</h1>
    <h2 id="price">1 161.99 MAD</h2>
    <p id="dsc">Alienware Pro Wireless Gaming Headset - Wired/Wireless,<br>
         Bluetooth 5.3, 15 Minute Fast Charging, Audio Output 20 Hz, <br>
         Battery Talk Time (ANC on) Up to 24 Hrs (Bluetooth)</p>
</aside>
