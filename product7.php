...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p7" src="p7.jpg">
    </div>
    
 <aside>
    <h1 id="as1">Gaming Headset</h1>
    <h2 id="price">1 055 MAD</h2>
    <p id="dsc">Logitech G733 Lightspeed Wireless Gaming Headset with <br>
        Suspension Headband, Lightsync RGB, Blue VO!CE mic technology <br>
        and PRO-G audio drivers </p>
</aside>
