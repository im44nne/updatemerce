...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p9" src="p9.jpg">
    </div>
    
   <aside>
    <h1 id="as1">Mechanical Gaming Keyboard </h1>
    <h2 id="price">474.72 MAD</h2>
    <p id="dsc">AULA F2088 Typewriter Style Mechanical Gaming Keyboard Blue Switches,<br>
        Rainbow LED Backlit,Removable Wrist Rest,Media Control Knob,Retro Punk Round Keycaps,<br>
        USB Wired Computer Keyboard</p>
</aside>
