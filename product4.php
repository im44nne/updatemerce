...
<body>
   ...
   <nav id="menu">
    ...
    <div id="menuint">
     ...
     <a href="cart.hphp"><img id="iconcrt" src="cart.jpg"></a>
   </nav>
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p4" src="p4.jpg">
    </div>
    
 <aside>
    <h1 id="as1">Gaming Keyboard</h1>
    <h2 id="price">456.22 MAD</h2>
    <p id="dsc">ASUS ROG Delta II Wireless Gaming Headset <br>
        (BT, ROG SpeedNova 2.4GHz, 3.5mm, 50mm Titanium-Plated Drivers, <br>
        10mm Super-Wideband Mic, 110HR Battery, DualFlow Audio, for PC, Switch, PS5, Xbox)</p>
</aside>
