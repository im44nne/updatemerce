...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p11" src="p11.jpg">
    </div>
    
 <aside>
    <h1 id="as1">Wireless Gaming Mouse </h1>
    <h2 id="price">261.5 MAD</h2>
    <p id="dsc">UHURU Wireless Gaming Mouse Up to 10000 DPI,<br>
         Rechargeable USB Wireless Mouse with 6 Buttons 7 Dynamic LED Color <br>
         Ergonomic Programmable MMO RPG for PC Laptop, Compatible with Windows Mac</p>
</aside>
