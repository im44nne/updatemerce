...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p8" src="p8.jpg">
        </div>
        
     <aside>
        <h1 id="as1">Gaming Monitor</h1>
        <h2 id="price">1 569.5 MAD</h2>
        <p id="dsc">32 inch Curved Monitor 144hz/180hz Gaming Monitor <br>
             1500R QHD (2560x1440p) 2k Computer Monitor Screen with FreeSync,<br>
              DisplayPort, HDMI, Wall Mountable</p>
    </aside>
