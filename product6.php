...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p6" src="p6.jpg">
        </div>
        
     <aside>
        <h1 id="as1">Alienware Pro Wireless Gaming Headset</h1>
        <h2 id="price">532.96 MAD</h2>
        <p id="dsc">AULA 99 Key Keyboard, Tri-Mode Bluetooth/2.4GHz/USB-C <br>
            Cute Creamy Gaming Keyboard with Number Pad RGB Backlit, <br>
            Media Knob Custom Mechanical Feel Computer Keyboards for MAC Xbox PC Gamer </p>
    </aside>
