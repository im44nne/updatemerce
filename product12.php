...
<body>
   ...
   <br><br>
    <div id="nav">
        ...
        <br>
        <img id="p12" src="p12.jpg">
    </div>
    
 <aside>
    <h1 id="as1">Gaming Headset</h1>
    <h2 id="price">500 MAD</h2>
    <p id="dsc">Gaming Headset for PC, Ps5, Switch, Mobile, Gaming Headphones <br>
        for Nintendo with Noise Canceling Mic, Deep Bass Stereo Sound</p>
</aside>
